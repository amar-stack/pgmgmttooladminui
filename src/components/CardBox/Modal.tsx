...
const CardBoxModal = ({
  ...
  return (
    <OverlayLayer onClick={onCancel} className={onCancel ? 'cursor-pointer' : ''}>
      <CardBox
        className={`transition-transform shadow-lg max-h-modal w-11/12 md:w-4/5 lg:w-4/5 xl:w-3/5 z-50`}
        isModal
        footer={footer}
      >
        ...
        {/* <Button label="generatedocslink" color={buttonColor} onClick={onConfirm} /> */}
